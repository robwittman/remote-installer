...
func (r *RemoteInstallationReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	// TODO: Create a job to install the remote resource

	// TODO: Monitor job for completion / failure

	// TODO: If successful, update as such, and exit

	// TODO: If failed, and under retry limit, initiate job again

	// TODO: If we failed, and past our retry limit, mark as failed and exit
